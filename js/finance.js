...
function _chargerSheetJS() {
  ...
  _sheetjsChargement = new Promise(function(resolve, reject) {
    ...
    // FIX (bug réel signalé — échec de chargement chez un utilisateur) :
    // cdnjs.cloudflare.com semble bloqué sur son réseau, alors que
    // cdn.jsdelivr.net (déjà utilisé ailleurs dans l'app pour le QR code
    // et Tesseract.js) fonctionne chez lui. Même bibliothèque, même
    // version, fournisseur différent — pour éviter ce point de panne.
