...
function renderDetail() {
  ...
  // FIX (bug réel trouvé via capture d'écran) : si les lignes d'une
  // facture sont stockées en base comme texte JSON brut plutôt qu'un
  // vrai tableau (arrive avec certaines données plus anciennes ou
  // importées), (f.lignes||[]).map(...) plantait ici avec une
