...
async function saveProfil() {
  ...
  if (typeof validerIdentifiantsLegaux === 'function' && !validerIdentifiantsLegaux(el('pe-ice')?.value.trim(), el('pe-rc')?.value.trim(), el('pe-if')?.value.trim(), el('pe-patente')?.value.trim(), el('pe-cnss')?.value.trim(), el('pe-rib')?.value.trim(), el('pe-tel')?.value.trim())) return;
